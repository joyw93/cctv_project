...
def detect(weights=ROOT / 'cctv_v5.pt',  # model.pt path(s)
        source='http://cctvsec.ktict.co.kr/75/eLxJsYCD/cubWfDXhbtph+o1TQzbtCsi6NxtJhISE+yjxH4Pn1Sxx/5MsokgIoKOJXKSl7rN63kJ/R6W8RkFsKSB2gtu2OKagPub1pyR9Pc=',  # file/dir/URL/glob, 0 for webcam
